...
<head>
    ...
    <title>E-commerce TECHTOWER 2024</title>
        ...
        <div class="container">
            <div class="linha">
                ...
                <div class="rodape-col-1">
                    ...
                    <div class="app-logo">
                    <a href = "https://play.google.com/store/games?hl=pt_BR&gl=US&pli=1"><img src = "assets/img/google.png" alt = ""></a>
...
function finalizarPedido() {
    ...
    // Verifica se há pedidos no carrinho
    if (pedidos.length === 0) {
        // Se não houver pedidos, exibe uma mensagem informando que o carrinho está vazio
    ...
    // Exibe um alerta informando ao usuário para fazer o login ou se cadastrar
    alert('Faça o seu cadastro ou realize o login para finalizar o pedido.');
