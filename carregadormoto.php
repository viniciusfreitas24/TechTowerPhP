...
<head>
    ...
    <title>Carregador Motorola</title>
...
<body>
    ...
    <div class="corpo-categorias ver-produto">
        <div class="linha">
            ...
            <div class="col-2">
                <img src="assets/produtos/carregadormototipoC.webp" alt="" id="produtoImg">
            ...
            <div class="col-2">
                ...
                <form action="" method="post">
                  ...
                  <button class="btn" onclick="adicionarAoCarrinho('Carregador Motorola', 84.99)">Adicionar ao Carrinho</button>
                ...
                <h3>Descrição:</h3>
                <p>Carregador Motorola</p>
                   <br>
                    <p>- Carregamento Turbopower™ Até 3x Mais Rápido</p>
            <br>
                     <p>- Compatibilidade com todo o sistema ANDROID e dispositivos habilitados para USB-C.</p> 
