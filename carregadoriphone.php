...
<body>
    ...
    <div class="corpo-categorias ver-produto">
        <div class="linha">
            ...
            <div class="col-2">
                <img src="assets/produtos/carregadoriphone.webp" alt="" id="produtoImg">
            ...
            <div class="col-2">
                ...
                <form action="" method="post">
                   ...
                   <button class="btn" onclick="adicionarAoCarrinho('Carregador Iphone', 99.99)">Adicionar ao Carrinho</button>
                ...
                <h3>Descrição:</h3>
                <p>Carregador Iphone</p>
                   <br>
                    <p>- O carregador USB-C de 20W A Apple é rápida e eficiente, o que a torna ideal para uso em casa, no trabalho ou em qualquer lugar. </p>
                    <br>
                    <p>- É compatível com qualquer dispositivo com porta USB-C, mas recomendamos usá-lo com um iPad Pro de 11 polegadas ou um iPad Pro de 12,9 polegadas (3ª geração) para melhor desempenho.</p>
                    <br>
                    <p>- Você também pode conectá-lo ao iPhone 8 ou posterior para aproveitar o carregamento rápido.</p> 
