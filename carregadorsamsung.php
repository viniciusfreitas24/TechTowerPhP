...
<head>
    ...
    <title>Carregador Samsung</title>
...
<body>
    ...
    <div class="corpo-categorias ver-produto">
        <div class="linha">
            ...
            <div class="col-2">
                <img src="assets/produtos/carregadorsamUSB.webp" alt="" id="produtoImg">
            ...
            <div class="col-2">
                ...
                <form action="" method="post">
                   ...
                   <button class="btn" onclick="adicionarAoCarrinho('Carregador Samsung', 69.99)">Adicionar ao Carrinho</button>
                ...
                <h3>Descrição:</h3>
                <p>Carregador Samsung</p>
                   <br>
                    <p>- Leve com você o carregador Samsung. Você terá seu dispositivo sempre pronto e com 100% de bateria.</p>
<br>
                       <p> - Adaptado para onde você estiver. O adaptador de corrente para paredes oferece uma boa combinação de força e peso para que você possa carregar seu dispositivo onde precisar.</p> 
