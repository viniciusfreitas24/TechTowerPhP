...
<body>
    ...
    <div class="corpo-categorias ver-produto">
        <div class="linha">
            ...
            <div class="col-2">
                <img src="assets/produtos/motoedge40.webp" alt="" id="produtoImg">
            ...
            <div class="col-2">
                ...
                <form action="" method="post">
                  ...
                  <button class="btn" onclick="adicionarAoCarrinho('Motorola Moto E40', 2499.99)">Adicionar ao Carrinho</button>
                ...
                <p>128GB | 8GB RAM </p>
                   <br>
                    <p>- Surpreendente é sua tela Touchscreen de 6.5 polegadas, que coloca esse Motorola no topo de sua categoria. A resolução também é alta: 1600x720 pixel.</p> 
                    <br>
                    <p>- Enfatizamos a boa memória interna de 64 GB com a possibilidade de expansão.</p>
                    <br>
                    <p>- Este Motorola Moto E40 é um produto com poucos concorrentes em termos de multimídia graças à câmera de 48 megapixels que permite ao Motorola Moto E40 tirar fotos fantásticas com uma resolução de 8000x6000 pixels e gravar vídeos em alta definição (Full HD) com uma resolução de 1920x1080 pixels.</p>
